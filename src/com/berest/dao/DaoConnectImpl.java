...
public class DaoConnectImpl implements DaoConnect {
    ...
    public List<Student> showStudent(String name) {
        ...
        try {
            preparedStatement = connection.prepareStatement("SELECT * FROM STUDENTS WHERE STUDENT_NAME LIKE ?");
